...
namespace ITFCode.Core.Service.Tests.FilterHandlers.Complex
{
    public class BoolValueFilterHandler_Tests : BaseValueFilterHandlerBase_Tests<BoolValueFilterHandler, BoolValueFilter>
    {
        ...
        private void ExecuteTest(int count, string propertyName, BoolFilterMatchMode matchMode, bool value, Func<TestComplexClass, bool> valueGetter)
        {
